...
<body>
	<header class="menu">
		<nav>
			<ul>
				<li id="Home"><a href="#"><em class="fas fa-home"></em> Home</a></li>
	...
	<section class="wrapper effect">
		<header class="	title">	
			<h1 class="title-card">Grafica 1</h1>
				<ul class="set">	
					<li><a class="setting" href="#"><em class="fas fa-cogs"></em></a></li>
				</ul>
		</header>
			<p><canvas id="tiempo" width="450" height="164"></canvas></p>			
	</section>
	<section class="wrapper effect">	
		<header class="title">
